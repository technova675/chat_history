  ...
  return (
    <div className="relative" ref={wrapRef}>
      <button
        ...
        aria-expanded={open}
        className="flex w-full items-center gap-3 rounded-full border border-neutral-800 bg-neutral-950 py-2 pl-2 pr-4 transition-colors hover:bg-neutral-900 sm:w-[260px]"
      >
        <Row owner={active} />
        <svg
          viewBox="0 0 24 24"
